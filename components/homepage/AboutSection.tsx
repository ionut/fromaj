...
const AboutSection = () => {
  return (
    <div className="bg-green md:clip-top">
      <Container className="pt-[15%] lg:pt-[10%]" homeSection={true}>
        <div>
          <SectionTitle title="Misiunea noastră" className="text-white" />
          <div className="grid md:grid-cols-2 items-center mt-10">
            <div className="col-span-1 pr-6 space-y-5 text-center">
            ...
            <div className="col-span-1">
              <Image
                ...
                className="aspect-square w-full object-contain drop-shadow-image"
              />
            </div>
          </div>
        </div>
